 ...
 * @file: The buffer file name is storing chars.
 *
 ...
 * If file_to cannot be created or cannot be written to - exit code 99.
 * If file_to or from cannot be closed - exit code 100.
 */
